...
public interface ExamEvaluatorServer extends Remote {
	
	public boolean createUser(String user, String password) throws RemoteException;;
	public boolean isUserDuplicate(String user) throws RemoteException;;
