...
public class DataBaseAnswers {
    
    //Gets the correct answer of an exam from the database
    public static String[] GetDataBaseAnswers(String[] questionNumbers){
        ...
        try{
            PreparedStatement st = con.prepareStatement("SELECT answer FROM question WHERE idp = ?");
            for(int i = 0; i < 10; i++){
